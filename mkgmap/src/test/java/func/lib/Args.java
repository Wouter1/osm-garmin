...
public interface Args {
	public static final String TEST_RESOURCE_OSM = "src/test/resources/in/osm/";
	public static final String TEST_RESOURCE_MP = "src/test/resources/in/mp/";
	public static final String TEST_RESOURCE_IMG = "src/test/resources/in/img/";
